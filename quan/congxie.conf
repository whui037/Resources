...
;^https?:\/\/amdc\.m\.taobao\.com url script-response-body https://raw.githubusercontent.com/fmz200/wool_scripts/main/Scripts/amdc.js
...
# > 长城炼金术
# hostname = fintechappdr.cgws.com
# 感谢【Joe Joy】分享
...
# > 超级课程表
# hostname = 182.92.244.70
# 开屏广告 由【jinlvei】分享
^https?:\/\/182\.92\.244\.70\/d\/json url reject-dict

# > 潮玩宇宙
# hostname = ios-api.lucklyworld.com
# 开屏广告
...
# > 盯盯拍
# hostname = *.pglstatp-toutiao.com, api.htp.ad-scope.com.cn, appgw.ddpai.com, init.sms.mob.com
...
# > 番茄小说
# hostname = *.pangolin-sdk-toutiao.com, *.pangolin-sdk-toutiao.*, *.pstatp.com, *.pstatp.com.*, *.pglstatp-toutiao.com.*, *.pglstatp-toutiao.com, gurd.snssdk.com, gurd.snssdk.com.*, *default.ixigua.com
# 去章末广告
...
# > 国家地理
# hostname = dili.bdatu.com, wap.ngchina.cn
...
# > 高铁管家
# hostname = cdn.133.cn, jt.rsscc.com
...
# > 汇丰汇选
# hostname = m.prod.app.hsbcfts.com.cn
...
# > 驾校一点通
# hostname = richmanrules.ksedt.com, api.jxedt.com
# 开屏广告 感谢【jinlvei】分享
...
# > 韭菜公社
# hostname = jiucaigongshe.oss-cn-beijing.aliyuncs.com
# 开屏广告干净了,有小部分误杀
;^https?:\/\/jiucaigongshe\.oss-cn-beijing\.aliyuncs\.com\/.*.png url reject-200
# 开屏倒计时还在,没有误杀
...
^https?:\/\/open\.e\.kuaishou\.com\/rest\/e\/v3\/open\/univ$ url script-response-body https://raw.githubusercontent.com/app2smile/rules/master/js/adsense.js
...
^https?:\/\/vip1\.kuwo\.cn\/vip\/(enc\/user\/vip\?op=ui|v2\/theme\?op=gd) url script-response-body https://raw.githubusercontent.com/RuCu6/QuanX/main/Scripts/break/kuwo.js
...
# >>>>>>>>>>>>>>> ✅ L ✅ <<<<<<<<<<<<<<
# > 拉卡拉
# hostname = lamb.lakala.com, wallet.lakala.com
# 首页横幅+进货+借款广告
...
# > 乐堡潮玩馆小程序
# hostname = tbgapplet.carlsberg.asia
# 开屏广告+弹窗广告
...
# > LING Club-原菱菱邦
# hostname = cdn-oss.00bang.cn, api.00bang.cn
...
# > LocSim
# hostname = app.aa-ab.com
# 屏蔽虚拟定位升级弹窗
^https?:\/\/app\.aa-ab\.com\/home url reject-200

# > lofter
# hostname = ad.lofter.com, images.pinduoduo.com, lofter.lf127.net
# 开屏广告 感谢@林夕分享
...
# > 全球购骑士卡
# hostname = facade-api.black-unique.com
# 开屏广告 感谢【Kook】分享
...
# > 去哒
# hostname = iqushangwang.8quan.com
# 首页开屏广告 感谢【德克萨斯】分享
...
# > 苏e行
# hostname = ad.shunchangzhixing.com, api.bwton.com
# 需卸载重装，有缓存
...
# > 苏周到
# hostname = szdmobile.suzhou.gov.cn
...
# > 书旗小说
# hostname = ut2.shuqistat.com, dsp.toutiao.com, sf3-be-pack.pglstatp-toutiao.com, api-access.pangolin-sdk-toutiao.com, sq.sljkj.com, ocean.shuqireader.com, img-tailor.11222.cn, message.shuqireader.com, feedback.uc.cn, *.shuqireader.com, 101.91.69.26
...
# > 首汽约车
# hostname = gw-passenger.01zhuanche.com,
...
# > TT语音
# hostname = ga-album-cdnqn.52tt.com
...
# > 天府银行小程序
# hostname = chl.tf.cn, wechat.tf.cn
# 缴费弹窗广告
...
;^https?:\/\/xxyx-client-api\.xiaoxiaoyouxuan\.com\/client\/energy\/mall\/getUserEnergy url script-response-body https://raw.githubusercontent.com/fmz200/wool_scripts/main/Scripts/xxyx/xxyx.js
...
# > 希沃白板5
# hostname = cstore-en-public-tx.seewo.com
...
# > 香蕉是一种水果
# hostname = *.pipiapps.com, *.fuliapps.com, *.xiangjiaoapps.com, *.xiangxiangapps.com
...
# > 游戏时光
# hostname = app02.vgtime.com, www.vgtime.com
...
# > 追书神器
# hostname = adx-cn.anythinktech.com
^https?:\/\/adx-cn\.anythinktech\.com\/bid url reject-200

# > 作业帮
# hostname = syh.zybang.com
